...
public class Classroom extends World
{
    ...
    private void prepare()
    {
        ...
        DerekXu derekxu = new DerekXu("Derek", "Xu", 1, 1, 2);
        addObject(derekxu, 1, 1);
        derekxu.sitDown();

        EeshanWalia eeshanwalia = new EeshanWalia("Eeshan", "Walia", 3, 1, 2);
        addObject(eeshanwalia, 3, 1);
        eeshanwalia.sitDown(); 

        JennyWang jennywang = new JennyWang("Jenny", "Wang", 1, 2, 3);
        addObject(jennywang, 4, 1);
        jennywang.sitDown(); 
        
        KaifJeelani kaifjeelani = new KaifJeelani("Kaif", "Jeelani", 3,2, 3);
